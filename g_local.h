...
//	client_persistant_t	coop_respawn;	// what to set client->pers to on a respawn
	...
	team_t		team;  // What team the client is on.  
...
struct edict_s
{
	...
	// MIKE:  took out in effort to remove needless singleplayer code.
